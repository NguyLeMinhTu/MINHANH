                ...
                <form id="postCategoryForm" onSubmit={handleSubmit} className="flex-1 overflow-y-auto px-8 py-6 bg-gray-50/30">
                    <div className="space-y-5">
                        <div>
                            ...
                            <input required type="text" name="tenDanhMuc" value={formData.tenDanhMuc} onChange={handleChange} className="w-full px-3.5 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#DAA06D]/40 focus:border-[#DAA06D] bg-white transition-all shadow-sm" placeholder="VD: Tin tức thời trang" />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="moTa" rows="3" value={formData.moTa} onChange={handleChange} className="w-full px-3.5 py-2.5 text-sm border border-gray-200 rounded-xl bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-[#DAA06D]/40 focus:border-[#DAA06D] transition-all leading-relaxed" placeholder="Nhập mô tả ngắn gọn cho danh mục..."></textarea>
                        </div>
                        ...
                        <div className="pt-2">
                            <label className="flex items-center gap-2.5 text-sm text-gray-700 font-semibold cursor-pointer select-none">
                                <input 
                                    ...
                                    className="rounded text-[#DAA06D] focus:ring-[#DAA06D] w-4.5 h-4.5 cursor-pointer border-gray-300" 
                                /> 
