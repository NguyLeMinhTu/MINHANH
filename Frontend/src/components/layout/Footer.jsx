...
export default function Footer({ primary = "#af7b51" }) {
    return (
        <footer className="bg-white text-gray-800" aria-label="site-footer">
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="text-sm text-gray-700 space-y-4">
                            ...
                            <div className="flex items-center gap-4 mt-2 text-sm">
                                <div className="flex items-center gap-2">
                                    <svg className="w-5 h-5 text-gray-700" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M3 8l7-5 7 5v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8z" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
                    ...
                    <div>
                        ...
                        <div className="text-sm font-semibold mb-3">CÁC HÌNH THỨC THANH TOÁN</div>
            ...
            <div className="text-gray-600 text-center text-sm py-4">
